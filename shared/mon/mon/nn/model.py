...
class ModelMixin:
    ...
    Attributes:
        ...
        _model_dir (Path): The model's directory.
    ...
    _tasks    : list[Task]   = []         # A list of tasks that the model can perform.
    _mltypes  : list[MLType] = []         # A list of learning types that the model can perform.
    _model_dir: Path         = None       # The model's directory
    _zoo      : dict         = box.Box()  # A dictionary containing all pretrained weights of the model.
