...
This module provides the base classes for various types of datasets, including
single-domain datasets, dual-domain datasets, and evaluation datasets. These
classes serve as templates for creating custom datasets for different tasks
and data modalities.
"""
