...
class MobileIELLE(nn.Module, ModelMixin):
    ...
    zoo      : dict         = box.Box({
        "lolv1"    : {
            "url"        : None,
            "path"       : ROOT_DIR / "zoo/vision/enhancerestoremobileie/mobileie/lolv1/mobileie_lolv1_slim.pkl",
            "num_classes": None,
        },
        "lolv2real": {
            "url"        : None,
            "path"       : ROOT_DIR / "zoo/vision/enhancerestoremobileie/mobileie/lolv2real/mobileie_lolv2real_slim.pkl",
            "num_classes": None,
        },
    })
