...
class MobileIELLE(nn.Module, ModelMixin):
    ...
    zoo      : dict         = box.Box({
        "lolv1"    : {
            "url"        : None,
            "path"       : ROOT_DIR / "zoo/vision/enhance/multitask/mobileie/mobileie_lle/lolv1/mobileie_lle_lolv1_slim.pkl",
            "num_classes": None,
        },
        "lolv2real": {
            "url"        : None,
            "path"       : ROOT_DIR / "zoo/vision/enhance/multitask/mobileie/mobileie_lle/lolv2real/mobileie_lle_lolv2real_slim.pkl",
            "num_classes": None,
        },
    })
