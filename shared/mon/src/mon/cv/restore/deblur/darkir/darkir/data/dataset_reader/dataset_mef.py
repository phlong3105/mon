...
def main_dataset_mef(rank = 1,
                         test_path='../../data/datasets/MEF',
                         batch_size_test=1, 
                         verbose=False, 
                         num_workers=1, 
                         crop_type='Random',
...
if __name__ == '__main__':
    test_loader, samplers = main_dataset_mef(test_path='/mnt/valab-datasets/Low_Light_Enhancement_Datasets/MEF/MEF')
