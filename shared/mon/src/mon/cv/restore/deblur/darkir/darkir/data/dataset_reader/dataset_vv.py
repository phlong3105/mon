...
def main_dataset_vv(rank = 1,
                         test_path='../../data/datasets/VV',
                         batch_size_test=1, 
                         verbose=False, 
                         num_workers=1, 
                         crop_type='Random',
...
if __name__ == '__main__':
    test_loader, samplers = main_dataset_vv(test_path='/mnt/valab-datasets/Low_Light_Enhancement_Datasets/VV/VV/VV')
