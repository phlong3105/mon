...
__current_file   = os.path.abspath(__file__)                          # "workspaces/one/projects/visdrone/utils.py"
source_root_dir  = os.path.dirname(__current_file)                    # "workspaces/one/projects/visdrone"
