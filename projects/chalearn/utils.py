...
__current_file   = os.path.abspath(__file__)                          # "workspaces/one/src/projects/utils.py"
source_root_dir  = os.path.dirname(__current_file)                    # "workspaces/one/src/projects"
