...
This module provides various loss functions for training SALEO models.
"""
...
class ConfidenceGatedDepthLoss(Loss):
    ...
    def forward(self, image_i: Tensor, depth: Tensor, illu: Tensor) -> Tensor:
        ...
        Args:
            ...
            illu (Tensor): Predicted illumination map tensor of shape
        ...
        mask_h = torch.sigmoid((image_i[:, :, :-1, :] - 0.05) * 20)
        mask_w = torch.sigmoid((image_i[:, :, :, :-1] - 0.05) * 20)
