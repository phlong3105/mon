...
class ReflectanceINR(nn.Module):
    ...
    def __init__(
        ...
        *args, **kwargs
        ...
        coord_layers = []
        coord_layers.append(SineLinear(self.coords_dim, hidden_dim, is_first=True))
        for _ in range(1, num_layers - 1):
            coord_layers.append(SineLinear(hidden_dim, hidden_dim))
        coord_layers.append(SineLinear(hidden_dim, 1, is_last=True))
    ...
    def __init__(
        ...
        *args, **kwargs
        ...
        self.aux_net = nn.Sequential(
            SineLinear(aux_in_dim, hidden_dim),
