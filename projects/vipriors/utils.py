...
__current_file   = os.path.abspath(__file__)                          # "workspaces/one/projects/vipriors/utils.py"
source_root_dir  = os.path.dirname(__current_file)                    # "workspaces/one/projects/vipriors"
