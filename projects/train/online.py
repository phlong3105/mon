...
hosts = {
	"lp-labdesktop01-ubuntu": {
        "model"      : "zeroadce",
        "cfg"        : "zeroadce_c_lol226",
        # "weights"    : None,
        "weights"    : PROJECTS_DIR / "train" / "runs" / "train" / "lol226" / "zeroadce-c-lol226" / "weights" / "best.pt",
        "root"       : RUNS_DIR / "infer",
        "project"    : "lol226",
        "name"       : "aokigahara",
        "num_classes": None,
        "source"     : DATA_DIR / "lol" / "demo" / "aokigahara.mp4",
        "max_samples": None,
        "batch_size" : 1,
        "img_size"   : None,
		"devices"    : "0",
    ...
    "vsw-ws02": {
        ...
        "name"       : "traffic_night",
        "num_classes": None,
        "source"     : DATA_DIR / "lol" / "demo" / "traffic_night.mp4",
        "max_samples": None,
        "batch_size" : 1,
        "img_size"   : None,
		"devices"    : "0",
