...
hosts = {
	"lp-labdesktop01-ubuntu": {
        "model"      : "zeroadce",
        "cfg"        : "zeroadce-a",
        "weights"    : PROJECTS_DIR / "train" / "runs" / "train" / "lol4k" / "zeroadce-a-lol4k" / "weights" / "best.pt",
        "root"       : RUNS_DIR / "infer",
        "project"    : "sice",
        "name"       : "zeroadce-a-lol4k",
        "num_classes": None,
    ...
    "vsw-ws02": {
        "model"      : "zeroadce",
        "cfg"        : "zeroadce-a-large",
        "weights"    : PROJECTS_DIR / "train" / "runs" / "train" / "lol226" / "zeroadce-a-large-lol226" / "weights" / "best.pt",
        "root"       : RUNS_DIR / "infer",
        "project"    : "lol226",
        "name"       : "zeroadce-a-large-lol226",
        "num_classes": None,
        "source"     : DATA_DIR / "lol" / "train" / "low",
        # "source"     : DATA_DIR / "sice" / "part2_900x1200_low" / "low",
        "max_samples": None,
    ...
    "vsw-ws03": {
        "model"      : "zeroadce",
        "cfg"        : "zeroadce-e-large",
        "weights"    : PROJECTS_DIR / "train" / "runs" / "train" / "lol226" / "zeroadce-e-large-lol226" / "weights" / "best.pt",
        "root"       : RUNS_DIR / "infer",
        "project"    : "sice",
        "name"       : "zeroadce-e-large-lol226",
        "num_classes": None,
        # "source"     : DATA_DIR / "lol" / "train" / "low",
        "source"     : DATA_DIR / "sice" / "part2_900x1200_low" / "low",
        "max_samples": None,
