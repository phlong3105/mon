...
from aic import AICVehicleCountingCameraAsync
...
def main(args):
    ...
    # NOTE: Define camera
    camera           = AICVehicleCountingCameraAsync(**camera_cfg)
...
def parse_args():
    ...
    parser.add_argument("--dataset", default="aic21vehiclecount", help="Dataset to run on.")
    ...
    parser.add_argument("--queue_size",   default=10,    type=int, help="Max queue size")
