...
def parse_args():
    ...
    parser.add_argument("--conf-thres",  default=0.2,                                 nargs="+", type=float, help="Confidence threshold. Can be a string, scalar value or a list/tuple/dict of values for each class.")
...
if __name__ == "__main__":
    ...
    if args.from_txts:
        create_pkl_from_txts(
            ...
            conf_thres  = 0.5  # args.conf_thres
        )
    else:
