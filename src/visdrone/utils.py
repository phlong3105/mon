...
__current_file   = os.path.abspath(__file__)                          # "workspaces/one/src/visdrone/utils.py"
source_root_dir  = os.path.dirname(__current_file)                    # "workspaces/one/src/visdrone"
