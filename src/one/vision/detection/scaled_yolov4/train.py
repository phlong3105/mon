...
import one.vision.detection.scaled_yolov4.test as test  # import test.py to get mAP after each epoch
...
from one.vision.detection.scaled_yolov4.utils.general import labels_to_class_weights
from one.vision.detection.scaled_yolov4.utils.general import labels_to_image_weights
