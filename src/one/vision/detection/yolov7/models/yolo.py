...
from one.vision.detection.yolov7.models.common import *
from one.vision.detection.yolov7.models.experimental import *
...
class Model(nn.Module):
    ...
    def forward(
        ...
        list[Union[Tensor, None, list[Optional[Any]]]]
    ]:
        if augment:
    ...
    def forward_once(
        self, x: Tensor, profile: bool = False
    ) -> Union[Tensor, None, list[Union[Tensor, None, list[Optional[Any]]]]]:
        y  = []  # outputs
        dt = []
        for m in self.model:
    ...
    def nms(self, mode: bool = True):  # add or remove NMS module
    ...
    def info(self, verbose: bool = False, img_size: int = 640):  # print model information
        model_info(self, verbose, img_size)


def parse_model(d: dict, ch: Union[list, tuple]):  # model_dict, input_channels(3)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cfg",     default="yolor-csp-c.yaml", type=str, help="model.yaml")
