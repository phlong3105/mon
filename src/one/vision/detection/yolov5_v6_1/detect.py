...
from one.vision.detection.yolov5_v6_1.utils.datasets import IMG_FORMATS
from one.vision.detection.yolov5_v6_1.utils.datasets import LoadImages
from one.vision.detection.yolov5_v6_1.utils.datasets import LoadStreams
from one.vision.detection.yolov5_v6_1.utils.datasets import VID_FORMATS
...
from one.vision.detection.yolov5_v6_1.utils.general import check_imshow
...
def parse_args():
    ...
    parser.add_argument("--weights",        default=weights_dir/"yolov5x6_v6_1_coco.pt", nargs="+", type=str,   help="model path(s)")
