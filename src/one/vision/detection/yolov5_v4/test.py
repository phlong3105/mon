...
from one.vision.detection.yolov5_v4.utils.general import box_iou
...
from one.vision.detection.yolov5_v4.utils.general import coco80_to_coco91_class
...
from one.vision.detection.yolov5_v4.utils.metrics import ap_per_class
from one.vision.detection.yolov5_v4.utils.metrics import ConfusionMatrix
from one.vision.detection.yolov5_v4.utils.plots import output_to_target
from one.vision.detection.yolov5_v4.utils.plots import plot_images
from one.vision.detection.yolov5_v4.utils.plots import plot_study_txt
...
def test(
    ...
    if not training:
        ...
        dataloader = create_dataloader(
            data[task], imgsz, batch_size, gs, args, pad=0.5, rect=True,
...
def main(args: dict | Munch | argparse.Namespace):
    ...
    if args.task in ("train", "val", "test"):  # run normally
        ...
        for w in args.weights:
            test(args.data, w, args.batch_size, args.img_size, 0.25, 0.45, save_json=False, plots=False)
        ...
        for w in args.weights:
            ...
            for i in x:  # img-size
                print(f"\nRunning {f} point {i}...")
                r, _, t = test(args.data, w, args.batch_size, i, args.conf_thres, args.iou_thres, args.save_json,
                               plots=False)
