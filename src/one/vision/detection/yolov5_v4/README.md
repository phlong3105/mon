...
Namespace(agnostic_nms=False, augment=False, classes=None, min_confidence=0.25, device='', exist_ok=False, img_size=640, nms_max_overlap=0.45, name='exp', project='runs/detect', save_conf=False, save_txt=False, source='aicity2021/images/', update=False, view_img=False, weights=['yolov5s.pt'])
