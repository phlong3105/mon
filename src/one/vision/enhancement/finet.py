...
cfgs = {
    ...
    "finet-x0.5": {
        ...
        "backbone": [
            ...
            [[-1],         1,      FINetConvBlock,      [32,  True,  0.2, False, True, 0.5, "linear"]],   # 2  (x1_1_down, x1_1)
            [-1,           1,      ExtractItem,         [0]],                                             # 3  (x1_1_down)
            [[-1],         1,      FINetConvBlock,      [64,  True,  0.2, False, True, 0.5, "linear"]],   # 4  (x1_2_down, x1_2)
            [-1,           1,      ExtractItem,         [0]],                                             # 5  (x1_2_down)
            [[-1],         1,      FINetConvBlock,      [128, True,  0.2, False, True, 0.5, "linear"]],   # 6  (x1_3_down, x1_3)
            [-1,           1,      ExtractItem,         [0]],                                             # 7  (x1_3_down)
            [[-1],         1,      FINetConvBlock,      [256, True,  0.2, False, True, 0.5, "linear"]],   # 8  (x1_4_down, x1_4)
            [-1,           1,      ExtractItem,         [0]],                                             # 9  (x1_4_down)
            [[-1],         1,      FINetConvBlock,      [512, False, 0.2, False, True, 0.5, "linear"]],   # 10 (None,      x1_5)
            # UNet 01 Skip
            [2,            1,      ExtractItem,         [1]],                                             # 11 (x1_1)
            ...
            [[-1, 11, 23], 1,      FINetConvBlock,      [32,  True,  0.2, True,  True, 0.5, "linear"]],   # 30 (x2_1_down, x2_1)
            [-1,           1,      ExtractItem,         [0]],                                             # 31 (x2_1_down)
            [[-1, 13, 22], 1,      FINetConvBlock,      [64,  True,  0.2, True,  True, 0.5, "linear"]],   # 32 (x2_2_down, x2_2)
            [-1,           1,      ExtractItem,         [0]],                                             # 33 (x2_2_down)
            [[-1, 15, 21], 1,      FINetConvBlock,      [128, True,  0.2, True,  True, 0.5, "linear"]],   # 34 (x2_3_down, x2_3)
            [-1,           1,      ExtractItem,         [0]],                                             # 35 (x2_3_down)
            [[-1, 17, 20], 1,      FINetConvBlock,      [256, True,  0.2, True,  True, 0.5, "linear"]],   # 36 (x2_4_down, x2_4)
            [-1,           1,      ExtractItem,         [0]],                                             # 37 (x2_4_down)
            [[-1],         1,      FINetConvBlock,      [512, False, 0.2, False, True, 0.5, "linear"]],   # 38 (None,      x2_5)
            # UNet 02 Skip
            [30,           1,      ExtractItem,         [1]],                                             # 39 (x2_1)
    ...
    "finet-denoise": {
        ...
        "backbone": [
            ...
            # UNet 01 Down
            [-1,           1,      Conv2d,              [32, 3, 1, 1]],                                   # 1  (x1)
            [[-1],         1,      FINetConvBlock,      [32,  True,  0.2, False, False, 0.5, "linear"]],  # 2  (x1_1_down, x1_1)
            [-1,           1,      ExtractItem,         [0]],                                             # 3  (x1_1_down)
            [[-1],         1,      FINetConvBlock,      [64,  True,  0.2, False, False, 0.5, "linear"]],  # 4  (x1_2_down, x1_2)
            [-1,           1,      ExtractItem,         [0]],                                             # 5  (x1_2_down)
            [[-1],         1,      FINetConvBlock,      [128, True,  0.2, False, False, 0.5, "linear"]],  # 6  (x1_3_down, x1_3)
            [-1,           1,      ExtractItem,         [0]],                                             # 7  (x1_3_down)
            [[-1],         1,      FINetConvBlock,      [256, True,  0.2, False, True,  0.5, "linear"]],  # 8  (x1_4_down, x1_4)
            [-1,           1,      ExtractItem,         [0]],                                             # 9  (x1_4_down)
            [[-1],         1,      FINetConvBlock,      [512, False, 0.2, False, True,  0.5, "linear"]],  # 10 (None,      x1_5)
            ...
            [[-1, 25],     1,      Concat,              []],                                              # 28 (x2 + sam_features)
            [-1,           1,      Conv2d,              [32, 1, 1, 0]],                                   # 29 (x2)
            [[-1, 11, 23], 1,      FINetConvBlock,      [32,  True,  0.2, True,  False, 0.5, "linear"]],  # 30 (x2_1_down, x2_1)
            [-1,           1,      ExtractItem,         [0]],                                             # 31 (x2_1_down)
            [[-1, 13, 22], 1,      FINetConvBlock,      [64,  True,  0.2, True,  False, 0.5, "linear"]],  # 32 (x2_2_down, x2_2)
            [-1,           1,      ExtractItem,         [0]],                                             # 33 (x2_2_down)
            [[-1, 15, 21], 1,      FINetConvBlock,      [128, True,  0.2, True,  False, 0.5, "linear"]],  # 34 (x2_3_down, x2_3)
            [-1,           1,      ExtractItem,         [0]],                                             # 35 (x2_3_down)
            [[-1, 17, 20], 1,      FINetConvBlock,      [256, True,  0.2, True,  True,  0.5, "linear"]],  # 36 (x2_4_down, x2_4)
            [-1,           1,      ExtractItem,         [0]],                                             # 37 (x2_4_down)
            [[-1],         1,      FINetConvBlock,      [512, False, 0.2, False, True,  0.5, "linear"]],  # 38 (None,      x2_5)
