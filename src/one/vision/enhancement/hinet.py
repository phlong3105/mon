...
cfgs = {
    "hinet": {
        ...
        "backbone": [
            ...
            # UNet 01 Up
            [[19, 18],     1,      HINetUpBlock,        [512,  0.2]],                     # 20 (x1_4_up = x1_5    + x1_4_skip)
            ...
            # UNet 02 Up
            [[-1, 46],     1,      HINetUpBlock,        [512,  0.2]],                     # 49 (x2_4_up = x2_5    + x2_4_skip)
            [[-1, 44],     1,      HINetUpBlock,        [256,  0.2]],                     # 50 (x2_3_up = x2_4_up + x2_3_skip)
            [[-1, 42],     1,      HINetUpBlock,        [128,  0.2]],                     # 51 (x2_2_up = x2_3_up + x2_2_skip)
            [[-1, 40],     1,      HINetUpBlock,        [64,   0.2]],                     # 52 (x2_1_up = x2_2_up + x2_1_skip)
        ],
        "head": [
            [-1,           1,      Conv2d,              [3, 3, 1, 1]],                    # 53
            [[-1,  0],     1,      Sum,                 []],                              # 54
            [[26, -1],     1,      Join,                []],                              # 55
        ]
    },
