...
@DATASETS.register(name="kodas_lol")
class KODASLoL(ImageEnhancementDataset):
    """
    KODASLoL dataset.
...
@DATAMODULES.register(name="kodas_lol")
class KODASLoLDataModule(DataModule):
    """
    KODASLoL DataModule.
    """
    ...
    def setup(self, phase: ModelPhase_ | None = None):
        ...
        Args:
            phase (ModelPhase_ | None):
                ...
                Defaults to None.
        """
        console.log(f"Setup [red]{KODASLoL.absclsname}[/red] datasets.")
...
def test_kodas_lol():
    cfg = {
        "root": DATA_DIR / "kodas" / "kodas19lol",
