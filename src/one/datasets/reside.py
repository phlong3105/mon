...
class RESIDESOTSOutdoor(ImageEnhancementDataset):
    ...
    def list_labels(self):
        ...
        with progress_bar() as pbar:
            for img in pbar.track(
                self.images,
                description=f"[bright_yellow]Listing RESIDE-SOTS Outdoor {self.split} labels"
            ):
                dir  = img.path.parents[1]
                stem = str(img.path.stem).split("_")[0]
                path = dir / "clear" / f"{stem}.png"
...
@DATAMODULES.register(name="reside_hsts")
    ...
    def setup(self, phase: ModelPhase_ | None = None):
        ...
        Args:
            phase (ModelPhase_ | None):
                ...
                Defaults to None.
        """
        console.log(f"Setup [red]{RESIDEHSTS.absclsname}[/red] datasets.")
    ...
    def setup(self, phase: ModelPhase_ | None = None):
        ...
        Args:
            phase (ModelPhase_ | None):
                ...
                Defaults to None.
        """
        console.log(f"Setup [red]{RESIDEITS.absclsname}[/red] datasets.")
        phase = ModelPhase.from_value(phase) if phase is not None else phase
    ...
    def setup(self, phase: ModelPhase_ | None = None):
        ...
        Args:
            phase (ModelPhase_ | None):
                ...
                Defaults to None.
        """
        console.log(f"Setup [red]{RESIDEITSv2.absclsname}[/red] datasets.")
        phase = ModelPhase.from_value(phase) if phase is not None else phase
    ...
    def setup(self, phase: ModelPhase_ | None = None):
        ...
        Args:
            phase (ModelPhase_ | None):
                ...
                Defaults to None.
        """
        console.log(f"Setup [red]{RESIDEOTS.absclsname}[/red] datasets.")
        phase = ModelPhase.from_value(phase) if phase is not None else phase
...
@DATAMODULES.register(name="reside_sots")
    ...
    def setup(self, phase: ModelPhase_ | None = None):
        ...
        Args:
            phase (ModelPhase_ | None):
                ...
                Defaults to None.
        """
        console.log(f"Setup [red]{RESIDESOTS.absclsname}[/red] datasets.")
        phase = ModelPhase.from_value(phase) if phase is not None else phase
...
@DATAMODULES.register(name="reside_ots_indoor")
    ...
    def setup(self, phase: ModelPhase_ | None = None):
        ...
        Args:
            phase (ModelPhase_ | None):
                ...
                Defaults to None.
        """
        console.log(f"Setup [red]{RESIDESOTSIndoor.absclsname}[/red] datasets.")
        phase = ModelPhase.from_value(phase) if phase is not None else phase
...
@DATAMODULES.register(name="reside_ots_outdoor")
    ...
    def setup(self, phase: ModelPhase_ | None = None):
        ...
        Args:
            phase (ModelPhase_ | None):
                ...
                Defaults to None.
        """
        console.log(f"Setup [red]{RESIDESOTSOutdoor.absclsname}[/red] datasets.")
        phase = ModelPhase.from_value(phase) if phase is not None else phase
