...
for split in splits:
	annotation_pattern = os.path.join(data_dir, "waymo", "detection2d", split, "front_easy", annotations_dir, "*.txt")
	...
	class_labels_path    = os.path.join(data_dir, "waymo", "detection2d", f"class_labels.json")
