...
def convert_yolo_labels(
	...
	*args, **kwargs
	...
	image_pattern = os.path.join(
		data_dir, "chalearn", "../../../../../../../projects/chalearn/data/ltd22", split, "*", "images", "*", "*", "*.jpg"
	)
...
def read_pkl_results():
	pkl_file = os.path.join(data_dir, "chalearn", "../../../../../../../projects/chalearn/data/ltd22", "toolkit", "sample_predictions.pkl")
...
def shuffle_images_labels(split: str = "train", subset: str = "month"):
	...
	label_pattern = os.path.join(
		data_dir, "chalearn", "../../../../../../../projects/chalearn/data/ltd22", split, subset, "yolo", "*", "*", "*.txt"
	)
	...
	with progress_bar() as pbar:
		for i in pbar.track(
			...
			out_image = os.path.join(
				data_dir, "chalearn", "../../../../../../../projects/chalearn/data/ltd22", "extra", subset, split, "images", f"{idx}.jpg"
			)
			out_label = os.path.join(
				data_dir, "chalearn", "../../../../../../../projects/chalearn/data/ltd22", "extra", subset, split, "labels", f"{idx}.txt"
			)
