...
moving_object = {
    ...
    "min_counting_distance": -50,   # Minimum distance to the ROI's center that the object is considered for counting.
...
detector      = {
    ...
    "weight"        : _current_dir/"yolov8x-aic23-autocheckout-mix-117-1920-01.pt",
