...
class ModelPhase(enum.Enum):
    ...
    def str_mapping(cls) -> dict[str, ModelPhase]:
        """Return a :class:`dict` mapping :class:`str` to enum."""
        return {
    ...
    def int_mapping(cls) -> dict[int, ModelPhase]:
        """Return a :class:`dict` mapping :class:`int` to enum."""
        return {
            0: cls.TRAINING,
            1: cls.TESTING,
            2: cls.INFERENCE,
...
class InterpolationMode(enum.Enum):
    ...
    def cv_modes_mapping(cls) -> dict[InterpolationMode, int]:
        """Returns a :class:`dict` mapping cv2 interpolation mode to enum."""
        return {
...
METRIC_CONFIG = {
    # FR
    "ahiq"               : {"metric_mode": "FR", "lower_better": False, },
    "ckdn"               : {"metric_mode": "FR", "lower_better": False, },
    "cw-ssim"            : {"metric_mode": "FR", "lower_better": False, },
    "cw_ssim"            : {"metric_mode": "FR", "lower_better": False, },
    "dists"              : {"metric_mode": "FR", "lower_better": True , },
    "fsim"               : {"metric_mode": "FR", "lower_better": False, },
    "gmsd"               : {"metric_mode": "FR", "lower_better": True , },
    "haarpsi"            : {"metric_mode": "FR", "lower_better": False, },
    "lpips"              : {"metric_mode": "FR", "lower_better": True , },
    "lpips-vgg"          : {"metric_mode": "FR", "lower_better": True , },
    "lpips_vgg"          : {"metric_mode": "FR", "lower_better": True , },
    "mad"                : {"metric_mode": "FR", "lower_better": False, },
    "mdsi"               : {"metric_mode": "FR", "lower_better": False, },
    "ms-gmsd"            : {"metric_mode": "FR", "lower_better": False, },
    "ms-ssim"            : {"metric_mode": "FR", "lower_better": False, },
    "ms_gmsd"            : {"metric_mode": "FR", "lower_better": False, },
    "ms_ssim"            : {"metric_mode": "FR", "lower_better": False, },
    "nlpd"               : {"metric_mode": "FR", "lower_better": True , },
    "psnr"               : {"metric_mode": "FR", "lower_better": False, },
    "psnry"              : {"metric_mode": "FR", "lower_better": False, },
    "ssim"               : {"metric_mode": "FR", "lower_better": False, },
    "ssimc"              : {"metric_mode": "FR", "lower_better": False, },
    "stlpips"            : {"metric_mode": "FR", "lower_better": True , },
    "stlpips-vgg"        : {"metric_mode": "FR", "lower_better": True , },
    "stlpips_vgg"        : {"metric_mode": "FR", "lower_better": True , },
    "vif"                : {"metric_mode": "FR", "lower_better": False, },
    "vsi"                : {"metric_mode": "FR", "lower_better": False, },
    # NR
    "brisque"            : {"metric_mode": "NR", "lower_better": True , },
    "clipiqa"            : {"metric_mode": "NR", "lower_better": False, },
    "clipiqa+"           : {"metric_mode": "NR", "lower_better": False, },
    "clipiqa+_rn50_512"  : {"metric_mode": "NR", "lower_better": False, },
    "clipiqa+_vitL14_512": {"metric_mode": "NR", "lower_better": False, },
    "clipscore"          : {"metric_mode": "NR", "lower_better": False, },
    "cnniqa"             : {"metric_mode": "NR", "lower_better": False, },
    "dbcnn"              : {"metric_mode": "NR", "lower_better": False, },
    "entropy"            : {"metric_mode": "NR", "lower_better": False, },
    "fid"                : {"metric_mode": "NR", "lower_better": True , },
    "hyperiqa"           : {"metric_mode": "NR", "lower_better": False, },
    "laion_aes"          : {"metric_mode": "NR", "lower_better": False, },
    "maniqa"             : {"metric_mode": "NR", "lower_better": False, },
    "maniqa-kadid"       : {"metric_mode": "NR", "lower_better": False, },
    "maniqa-koniq"       : {"metric_mode": "NR", "lower_better": False, },
    "maniqa-pipal"       : {"metric_mode": "NR", "lower_better": False, },
    "musiq"              : {"metric_mode": "NR", "lower_better": False, },
    "musiq-ava"          : {"metric_mode": "NR", "lower_better": False, },
    "musiq-koniq"        : {"metric_mode": "NR", "lower_better": False, },
    "musiq-paq2piq"      : {"metric_mode": "NR", "lower_better": False, },
    "musiq-spaq"         : {"metric_mode": "NR", "lower_better": False, },
    "nima"               : {"metric_mode": "NR", "lower_better": False, },
    "nima-vgg16-ava"     : {"metric_mode": "NR", "lower_better": False, },
    "niqe"               : {"metric_mode": "NR", "lower_better": True , },
    "nrqm"               : {"metric_mode": "NR", "lower_better": False, },
    "paq2piq"            : {"metric_mode": "NR", "lower_better": False, },
    "pi"                 : {"metric_mode": "NR", "lower_better": True , },
    "pieapp"             : {"metric_mode": "NR", "lower_better": True , },
    "topiq_fr"           : {"metric_mode": "NR", "lower_better": False, },
    "topiq_fr-pipal"     : {"metric_mode": "NR", "lower_better": False, },
    "topiq_iaa"          : {"metric_mode": "NR", "lower_better": False, },
    "topiq_iaa_res50"    : {"metric_mode": "NR", "lower_better": False, },
    "topiq_nr"           : {"metric_mode": "NR", "lower_better": False, },
    "topiq_nr-face"      : {"metric_mode": "NR", "lower_better": False, },
    "topiq_nr-flive"     : {"metric_mode": "NR", "lower_better": False, },
    "topiq_nr-spaq"      : {"metric_mode": "NR", "lower_better": False, },
    "tres"               : {"metric_mode": "NR", "lower_better": False, },
    "tres-flive"         : {"metric_mode": "NR", "lower_better": False, },
    "tres-koniq"         : {"metric_mode": "NR", "lower_better": False, },
    "tv"                 : {"metric_mode": "NR", "lower_better": False, },
    "uranker"            : {"metric_mode": "NR", "lower_better": False, },
}
