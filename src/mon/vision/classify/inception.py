...
class InceptionA(nn.Module):
    ...
    def forward(self, input: torch.Tensor) -> torch.Tensor:
        ...
        y = torch.cat([branch1x1, branch5x5, branch3x3dbl, branch_pool], 1)
        return y
...
class InceptionB(nn.Module):
    ...
    def forward(self, input: torch.Tensor) ->torch. Tensor:
        ...
        y = torch.cat([branch3x3, branch3x3dbl, branch_pool], 1)
        return y
...
class InceptionC(nn.Module):
    ...
    def __init__(
        ...
        *args, **kwargs
        ...
        self.branch7x7_1    = conv_block(in_channels, channels_7x7, kernel_size=1)
        self.branch7x7_2    = conv_block(channels_7x7, channels_7x7, kernel_size=(1, 7), padding=(0, 3))
        self.branch7x7_3    = conv_block(channels_7x7, 192, kernel_size=(7, 1), padding=(3, 0))
        self.branch7x7dbl_1 = conv_block(in_channels, channels_7x7, kernel_size=1)
        self.branch7x7dbl_2 = conv_block(channels_7x7, channels_7x7, kernel_size=(7, 1), padding=(3, 0))
        self.branch7x7dbl_3 = conv_block(channels_7x7, channels_7x7, kernel_size=(1, 7), padding=(0, 3))
        self.branch7x7dbl_4 = conv_block(channels_7x7, channels_7x7, kernel_size=(7, 1), padding=(3, 0))
        self.branch7x7dbl_5 = conv_block(channels_7x7, 192, kernel_size=(1, 7), padding=(0, 3))
    ...
    def forward(self, input: torch.Tensor) -> torch.Tensor:
        ...
        branch_pool  = F.avg_pool2d(x, kernel_size=3, stride=1, padding=1)
        branch_pool  = self.branch_pool(branch_pool)
        y = torch.cat([branch1x1, branch7x7, branch7x7dbl, branch_pool], 1)
        return y
...
class InceptionD(nn.Module):
    ...
    def forward(self, input: torch.Tensor) -> torch.Tensor:
        ...
        branch_pool = F.max_pool2d(x, kernel_size=3, stride=2)
        y = torch.cat([branch3x3, branch7x7x3, branch_pool], 1)
        return y
...
class InceptionE(nn.Module):
    ...
    def forward(self, input: torch.Tensor) -> torch.Tensor:
        ...
        branch_pool  = F.avg_pool2d(x, kernel_size=3, stride=1, padding=1)
        branch_pool  = self.branch_pool(branch_pool)
        y = torch.cat([branch1x1, branch3x3, branch3x3dbl, branch_pool], 1)
        return y
...
class Inception3(base.ImageClassificationModel):
    ...
    zoo = {
        "imagenet1k-v1": {
            ...
            "path"       : "inception3-imagenet1k-v1.pth",
            "num_classes": 1000,
            "map": {},
        },
    }
    ...
    def __init__(
        ...
        *args, **kwargs
        ...
        self.AuxLogits: nn.Module | None = None
        if aux_logits:
    ...
    @torch.jit.unused
    def eager_outputs(self, x: torch.Tensor, aux: torch.Tensor | None) -> InceptionOutputs:
    ...
    def forward_once(
        ...
        *args, **kwargs
        ...
        x = self.dropout(x)  # N x 2048 x 1 x 1
