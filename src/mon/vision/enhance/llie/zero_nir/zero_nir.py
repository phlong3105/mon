...
__all__ = [
    ...
    "ZeroNIR_01_RGB",
    "ZeroNIR_02_RGB_Sep",
    "ZeroNIR_03_RGB_Sep_Bilateral",
    "ZeroNIR_04_RGBD_Sep",
    "ZeroNIR_05_RGBD_Sep_Bilateral",
    "ZeroNIR_06_RGBD_MoE",
]
...
@MODELS.register(name="zero_nir", arch="zero_nir")
class ZeroNIR(base.ImageEnhancementModel):
...
@MODELS.register(name="zero_nir_01_rgb", arch="zero_nir")
class ZeroNIR_01_RGB(ZeroNIR):
    
    def __init__(
        self,
        name          : str   = "zero_nir_01_rgb",
        embed_channels: int   = 48,
        window_size   : int   = 1,
        down_size     : int   = 256,
        num_layers    : int   = 4,
...
@MODELS.register(name="zero_nir_02_rgb_sep", arch="zero_nir")
class ZeroNIR_02_RGB_Sep(ZeroNIR):
    
    def __init__(
        self,
        name          : str   = "zero_nir_02_rgb_sep",
        embed_channels: int   = 48,
        window_size   : int   = 1,
        down_size     : int   = 256,
        num_layers    : int   = 4,
...
@MODELS.register(name="zero_nir_03_rgb_sep_bilateral", arch="zero_nir")
class ZeroNIR_03_RGB_Sep_Bilateral(ZeroNIR):
    
    def __init__(
        self,
        name          : str   = "zero_nir_03_rgb_sep_bilateral",
        embed_channels: int   = 48,
        window_size   : int   = 1,
        down_size     : int   = 256,
        num_layers    : int   = 4,
...
@MODELS.register(name="zero_nir_04_rgbd_sep", arch="zero_nir")
class ZeroNIR_04_RGBD_Sep(ZeroNIR):
    
    def __init__(
        self,
        name          : str   = "zero_nir_04_rgbd_sep",
        embed_channels: int   = 48,
        window_size   : int   = 1,
        down_size     : int   = 256,
        num_layers    : int   = 4,
...
@MODELS.register(name="zero_nir_05_rgbd_sep_bilateral", arch="zero_nir")
class ZeroNIR_05_RGBD_Sep_Bilateral(ZeroNIR):
    
    def __init__(
        self,
        name          : str   = "zero_nir_05_rgbd_sep_bilateral",
        embed_channels: int   = 48,
        window_size   : int   = 1,
        down_size     : int   = 256,
        num_layers    : int   = 4,
...
@MODELS.register(name="zero_nir_06_rgbd_moe", arch="zero_nir")
class ZeroNIR_06_RGBD_MoE(ZeroNIR):
    
    def __init__(
        self,
        name          : str   = "zero_nir_06_rgbd_moe",
        embed_channels: int   = 48,
        window_size   : int   = 1,
        down_size     : int   = 256,
        num_layers    : int   = 4,
