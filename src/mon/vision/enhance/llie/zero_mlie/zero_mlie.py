...
__all__ = [
    ...
    "ZeroMLIE_01_RGB",
    "ZeroMLIE_02_RGBD",
    "ZeroMLIE_03_RGBD_ZSN2N",
    "ZeroMLIE_04_HSV",
    "ZeroMLIE_05_HSVD",
    "ZeroMLIE_06_HSVD_ZSN2N",
    "ZeroMLIE_07_HVI",
    "ZeroMLIE_08_HVID",
    "ZeroMLIE_09_HVID_ZSN2N",
    "ZeroMLIE_10_HVI3",
    "ZeroMLIE_11_HVID3",
    "ZeroMLIE_12_HVID3_ZSN2N",
    "ZeroMLIE_13_RGBD_HSVD",
    "ZeroMLIE_14_RGBD_HSVD_ZSN2N",
]
...
@MODELS.register(name="zero_mlie_09_hvid_zsn2n", arch="zero_mlie")
class ZeroMLIE_09_HVID_ZSN2N(ZeroMLIE_08_HVID):
    
    def __init__(
        self,
        name   : str = "zero_mlie_09_hvid_zsn2n",
        weights: Any = None,
        *args, **kwargs
    ):
        super().__init__(
...
@MODELS.register(name="zero_mlie_10_hvi3", arch="zero_mlie")
class ZeroMLIE_10_HVI3(ZeroMLIE):
    
    def __init__(
        self,
        name        : str         = "zero_mlie_10_hvi3",
        window_size : int         = 1,
        down_size   : int         = 256,
        num_layers  : int         = 4,
        hidden_dim  : int         = 256,
...
@MODELS.register(name="zero_mlie_11_hvid3", arch="zero_mlie")
class ZeroMLIE_11_HVID3(ZeroMLIE):
    
    def __init__(
        self,
        name        : str         = "zero_mlie_11_hvid3",
        window_size : int         = 1,
        down_size   : int         = 256,
        num_layers  : int         = 4,
        hidden_dim  : int         = 256,
...
@MODELS.register(name="zero_mlie_12_hvid3_zsn2n", arch="zero_mlie")
class ZeroMLIE_12_HVID3_ZSN2N(ZeroMLIE_11_HVID3):
    
    def __init__(
        self,
        name   : str = "zero_mlie_12_hvid3_zsn2n",
        weights: Any = None,
        *args, **kwargs
    ):
        super().__init__(
...
@MODELS.register(name="zero_mlie_13_rgbd_hsvd", arch="zero_mlie")
class ZeroMLIE_13_RGBD_HSVD(ZeroMLIE):
    
    def __init__(
        self,
        name        : str         = "zero_mlie_13_rgbd_hsvd",
        window_size : int         = 1,
        down_size   : int         = 256,
        num_layers  : int         = 4,
        hidden_dim  : int         = 256,
...
@MODELS.register(name="zero_mlie_14_rgbd_hsvd_zsn2n", arch="zero_mlie")
class ZeroMLIE_14_RGBD_HSVD_ZSN2N(ZeroMLIE):
    
    def __init__(
        self,
        name        : str         = "zero_mlie_14_rgbd_hsvd_zsn2n",
        window_size : int         = 1,
        down_size   : int         = 256,
        num_layers  : int         = 4,
        hidden_dim  : int         = 256,
