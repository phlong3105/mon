...
@MODELS.register(name="llunet++_hvi")
class LLUnetPPHVI(base.LowLightImageEnhancementModel):
    """LLUnet++ (LLUnet++: UNet++ Based Nested Skip Connections Network for
    Low-Light Image Enhancement) model.
...
@MODELS.register(name="llunet++_nopool_hvi")
class LLUnetPPNoPoolHVI(base.LowLightImageEnhancementModel):
    """LLUnet++ (LLUnet++: UNet++ Based Nested Skip Connections Network for
    Low-Light Image Enhancement) model.
