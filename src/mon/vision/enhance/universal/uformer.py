...
class Uformer(base.UniversalImageEnhancementModel):
    ...
    def __init__(
        ...
        *args, **kwargs
        ...
        self.image_size       = core.get_hw(image_size)
        self.channels         = channels
        self.dd_in            = dd_in
...
class UformerSFastleff(Uformer):
    ...
    def __init__(
        ...
        weights   : Any       = None,
        name      : str       = "uformer",
        variant   : str       = "uformer_s_fastleff",
        *args, **kwargs
    ):
        super().__init__(
            image_size       = image_size,
