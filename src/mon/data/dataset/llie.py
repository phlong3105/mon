...
class DarkFace(datastruct.UnlabeledImageDataset):
...
class DICM(datastruct.UnlabeledImageDataset):
...
class ExDark(datastruct.UnlabeledImageDataset):
...
class FiveKC(datastruct.UnlabeledImageDataset):
...
class FiveKE(datastruct.ImageEnhancementDataset):
...
class Fusion(datastruct.UnlabeledImageDataset):
...
class LIME(datastruct.UnlabeledImageDataset):
...
class LOLBlur(datastruct.ImageEnhancementDataset):
...
class LOLV1(datastruct.ImageEnhancementDataset):
...
class LOLV2Real(datastruct.ImageEnhancementDataset):
...
class LOLV2Synthetic(datastruct.ImageEnhancementDataset):
...
class MEF(datastruct.UnlabeledImageDataset):
...
class NPE(datastruct.UnlabeledImageDataset):
...
class SICEGrad(datastruct.UnlabeledImageDataset):
    """SICE-Grad dataset.
...
class SICEMix(datastruct.UnlabeledImageDataset):
...
class SICEMixV2(datastruct.UnlabeledImageDataset):
    """SICE-MixV2 dataset.
...
class ULOL(datastruct.UnlabeledImageDataset):
...
class VV(datastruct.UnlabeledImageDataset):
...
class DarkFaceDataModule(datastruct.DataModule):
    """DarkFace datamodule.
...
class DICMDataModule(datastruct.DataModule):
    """DICM datamodule.
...
class ExDarkDataModule(datastruct.DataModule):
    """ExDark datamodule.
...
class FiveKCDataModule(datastruct.DataModule):
...
class FiveKEDataModule(datastruct.DataModule):
...
class FusionDataModule(datastruct.DataModule):
    """Fusion datamodule.
...
class LIMEDataModule(datastruct.DataModule):
    """LIME datamodule.
...
class LOLBlurDataModule(datastruct.DataModule):
    """LOL-Blur datamodule.
...
class LOLV1DataModule(datastruct.DataModule):
    """LOLV1 datamodule.
...
class LOLV2RealDataModule(datastruct.DataModule):
...
class LOLV2SyntheticDataModule(datastruct.DataModule):
...
class MEFDataModule(datastruct.DataModule):
    """MEF datamodule.
...
class NPEDataModule(datastruct.DataModule):
    """NPE datamodule.
...
class SICEGradDataModule(datastruct.DataModule):
...
class SICEMixDataModule(datastruct.DataModule):
    """SICE-Mix datamodule.
...
class SICEMixV2DataModule(datastruct.DataModule):
...
class ULOLMixDataModule(datastruct.DataModule):
...
class VVDataModule(datastruct.DataModule):
    """VV datamodule.
