...
import mon.core.datastruct.annotation.base
import mon.core.datastruct.annotation.bbox
import mon.core.datastruct.annotation.category
import mon.core.datastruct.annotation.classlabel
import mon.core.datastruct.annotation.image
import mon.core.datastruct.annotation.value
from mon.core.datastruct.annotation.base import *
from mon.core.datastruct.annotation.bbox import *
from mon.core.datastruct.annotation.category import *
from mon.core.datastruct.annotation.classlabel import *
from mon.core.datastruct.annotation.image import *
from mon.core.datastruct.annotation.value import *
