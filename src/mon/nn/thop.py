...
"""This module extend :mod:`thop.profile` to work with :mod:`mon.nn.model.Model`.
"""
...
def profile_origin(
	...
	"""Profiles a PyTorch model's operations and parameters by applying custom
	or default hooks and returns total operations and parameters.
	"""
	handler_collection = []
