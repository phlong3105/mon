...
__all__ = [
    "CFG_DIR", "CONTENT_ROOT_DIR", "DATA_DIR", "FILE_HANDLER", "ImageFormat",
    "MemoryUnit", "PRETRAINED_DIR", "PROJECTS_DIR", "RUNS_DIR",
    "SOURCE_ROOT_DIR", "VideoFormat",
]
...
__current_file   = pathlib.Path(__file__).absolute()  # "workspaces/one/src/one-core/one/core/constant.py"
SOURCE_ROOT_DIR  = __current_file.parents[2]          # "workspaces/one/src/one-core"
CONTENT_ROOT_DIR = __current_file.parents[4]          # "workspaces/one"
