...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Evaluate metric of the '
    ...
    parser.add_argument(
        ...
        help='Format the output results without perform evaluation. It is'
             'useful when you want to format the result to a specific format '
             'and '
    ...
    parser.add_argument(
        ...
        type=str,
        nargs='+',
        help='Evaluation metrics, which depends on the dataset, e.g., "box",'
