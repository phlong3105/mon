...
class CenterRegionAssigner(BaseAssigner):
    """Assign pixels at the center region of a box as positive.
    ...
    Args:
        ...
        foreground_dominate (bool): If True, the box will be assigned as
    ...
    def get_gt_priorities(self, gt_bboxes):
        ...
        # Rank all gt box areas. Smaller objects has larger priority
    ...
    def assign(self, bboxes, gt_bboxes, gt_bboxes_ignore=None, gt_labels=None):
        ...
        This method assigns gts to every box (proposal/anchor), each box \
        ...
        # Only calculate box and gt_core IoF. This enables small prior bboxes
        #   to match large gts
        ...
        if gt_labels is not None:
            ...
            pos_inds = torch.nonzero(
                assigned_gt_ids > 0, as_tuple=False
            ).squeeze()
            if pos_inds.numel() > 0:
    ...
    def assign_one_hot_gt_indices(
        ...
        Returns:
            tuple: Returns (assigned_gt_inds, shadowed_gt_inds).
                ...
                - shadowed_gt_inds: shadowed gt indices. It is a tensor of \
                    ...
                    shadowed prior box indices and the second column the \
        ...
        if gt_priority is None:
            gt_priority = torch.arange(
                num_gts, device=is_bbox_in_gt_core.devices
            )
        ...
        # Each box could match with multiple gts.
        ...
        # The matched gt index of each positive box. Length >= num_pos_anchor
        #   , since one box could match multiple gts
        matched_bbox_gt_inds = torch.nonzero(
            is_bbox_in_gt_core, as_tuple=False
        )[:, 1]
        # Assign priority to each box-gt pair.
