...
class MaxIoUAssigner(BaseAssigner):
    ...
    def assign(self, bboxes, gt_bboxes, gt_bboxes_ignore=None, gt_labels=None):
        ...
        1. assign every box to the background
    ...
    def assign_wrt_overlaps(self, overlaps, gt_labels=None):
        ...
        if self.match_low_quality:
            ...
            # prediction.
            # For example, if box A has 0.9 and 0.8 iou with GT box 1 & 2,
            # box 1 will be assigned as the best target for box A in step 3.
            # However, if GT box 2's gt_argmax_overlaps = A, box A's
            # assigned_gt_inds will be overwritten to be box B.
