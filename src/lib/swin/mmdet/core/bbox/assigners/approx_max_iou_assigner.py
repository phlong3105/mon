...
class ApproxMaxIoUAssigner(MaxIoUAssigner):
    ...
    def assign(
        ...
        This method assign a gt box to each group of approxs (bboxes),
        each group of approxs is represent by a base approx (box) and
        ...
        1. assign every box to background_label (-1)
        ...
        overlaps, _ = all_overlaps.view(
            approxs_per_octave, num_squares,
            num_gts
        ).max(dim=0)
