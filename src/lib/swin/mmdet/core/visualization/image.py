...
def imshow_det_bboxes(
    ...
    Args:
        ...
        bbox_color (str or tuple(int) or :obj:`Color`):Color of box lines.
...
def imshow_gt_det_bboxes(
    ...
    Args:
      ...
      class_names (list[str]): Names of each classes.
      score_thr (float): Minimum score of bboxes to be shown.  Default: 0
      gt_bbox_color (str or tuple(int) or :obj:`Color`):Color of box lines.
      ...
      gt_mask_color (str or tuple(int) or :obj:`Color`, optional):
           Color of masks. The tuple of color should be in BGR order.
           Default: (255, 102, 61)
      det_bbox_color (str or tuple(int) or :obj:`Color`):Color of box lines.
