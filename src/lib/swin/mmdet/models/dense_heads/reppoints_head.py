...
from mmdet.core import (
    ...
    multiclass_nms, PointGenerator, unmap,
)
...
class RepPointsHead(AnchorFreeHead):
    ...
    def _point_target_single(
        ...
        if unmap_outputs:
            ...
            label_weights = unmap(
                label_weights, num_total_proposals,
                inside_flags
            )
            bbox_gt = unmap(bbox_gt, num_total_proposals, inside_flags)
            pos_proposals = unmap(
                pos_proposals, num_total_proposals,
                inside_flags
            )
            proposals_weights = unmap(
                proposals_weights, num_total_proposals,
                inside_flags
            )
    ...
    def loss_single(
        self, cls_score, pts_pred_init, pts_pred_refine, labels,
