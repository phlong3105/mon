...
class FreeAnchorRetinaHead(RetinaHead):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(
            ...
            num_classes, in_channels, stacked_convs, conv_cfg,
            norm_cfg, **kwargs
        )
    ...
    def positive_bag_loss(self, matched_cls_prob, matched_box_prob):
        ...
        :math:`P_{ij}^{cls}`: matched_cls_prob, classification probability of
        matched samples.

        :math:`P_{ij}^{loc}`: matched_box_prob, box probability of matched
        samples.
