...
class FCOSHead(AnchorFreeHead):
    ...
    Args:
        ...
        centerness_on_reg (bool): If true, position centerness on the
            ...
            https://github.com/tianzhi0549/FCOS/issues/89#issuecomment
            -516877042.
            Default: False.
        conv_bias (bool | str): If specified as `auto`, it will be decided by
        the
            norm_cfg. Bias of conv will be set as True if `norm_cfg` is None,
            otherwise
            False. Default: "auto".
    ...
    def forward_single(self, x, scale, stride):
        ...
        Args:
            ...
            stride (int): The corresponding stride for feature maps, only
                used to normalize the box prediction when self.norm_on_bbox
                is True.

        Returns:
            tuple: scores for each class, box predictions and centerness \
    ...
    def loss(
        ...
        num_pos = torch.tensor(
            len(pos_inds), dtype=torch.float, device=bbox_preds[0].devices
        )
    ...
    def _get_target_single(
        ...
        if self.center_sampling:
            # condition1: inside a `center box`
