...
from mmdet.core import (
    anchor_inside_flags, images_to_levels, multi_apply,
    unmap,
)
...
class FSAFHead(RetinaHead):
    ...
    def _get_targets_single(
        ...
        Most of the codes are the same with the base class
          ...
          anchor box is not matched to any gt, the corresponding value in
          pos_gt_inds is -1.
        """
    ...
    def loss(
        ...
        for i in range(len(bbox_preds)):  # loop over fpn level
            # avoid 0 area of the predicted box
        ...
        # gt index of each anchor box in each fpn level.
    ...
    def collect_loss_level_single(
        self, cls_loss, reg_loss, assigned_gt_inds,
        labels_seq
    ):
    ...
    def reweight_loss_single(
        ...
        Args:
            ...
            reg_loss (Tensor): Element-wise regression loss.
              Shape: (num_anchors, 4)
            assigned_gt_inds (Tensor): The gt indices that each anchor box
