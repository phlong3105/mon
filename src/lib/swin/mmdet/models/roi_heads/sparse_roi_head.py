...
from mmdet.core.box.samplers import PseudoSampler
...
class SparseRoIHead(CascadeRoIHead):
    ...
    def _bbox_forward(self, stage, x, rois, object_feats, img_metas):
        ...
        Returns:
            dict[str, Tensor]: a dictionary of box head outputs,
        ...
        cls_score, bbox_pred, object_feats = bbox_head(
            bbox_feats,
            object_feats
        )
