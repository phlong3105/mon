...
from mmdet.core import (
    bbox2result, bbox2roi, bbox_mapping, build_assigner,
...
class CascadeRoIHead(BaseRoIHead, BBoxTestMixin, MaskTestMixin):
    """Cascade roi head including one box head and one mask head.
    ...
    def _bbox_forward_train(
        self, stage, x, sampling_results, gt_bboxes,
