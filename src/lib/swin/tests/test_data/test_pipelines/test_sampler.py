...
from mmdet.core.box.assigners import MaxIoUAssigner
from mmdet.core.box.samplers import (
...
def test_ohem_sampler():
    ...
    feats = [torch.rand(1, 256, int(2 ** i), int(2 ** i)) for i in
             [6, 5, 4, 3, 2]]
...
def test_random_sample_result():
    from mmdet.core.box.samplers.sampling_result import SamplingResult
