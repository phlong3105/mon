...
# Log specifications
parser.add_argument('--save', type=str, default=RUN_DIR / 'predict/vision/enhance/derain/ipt/',
...
parser.add_argument('--pretrain', type=str, default= ZOO_DIR / "vision/enhance/derain/ipt/IPT_derain.pt")
