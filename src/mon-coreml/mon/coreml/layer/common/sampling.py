...
from mon.coreml import constant, util
from mon.coreml.layer import base
from mon.coreml.typing import FloatAnyT, IntAnyT, Ints
...
class Downsample(base.PassThroughLayerParsingMixin, nn.Module):
    ...
    def __init__(
        self,
        size                  : Ints      | None = None,
        scale_factor          : FloatAnyT | None = None,
        mode                  : str              = "nearest",
...
class Scale(base.PassThroughLayerParsingMixin, nn.Module):
    ...
    Args:
        scale: Initial value of scale factor. Defaults to 1.0.
    """
...
class Interpolate(base.PassThroughLayerParsingMixin, nn.Module):
    ...
    def __init__(self, size: IntAnyT, *args, **kwargs):
        super().__init__()
        self.size = util.to_size(size)
