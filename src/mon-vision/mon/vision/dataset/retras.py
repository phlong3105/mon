...
@DATASETS.register(name="retras-vnight")
...
@DATAMODULES.register(name="retras-vnight")
...
def parse_args():
    ...
    parser.add_argument("--task", type=str, default="test-retras-vnight", help="The task to run.")
...
if __name__ == "__main__":
    args = parse_args()
    if args.task == "test-retras-vnight":
        test_retras_vnight()
