...
""":mod:`mon.vision.dataset.a2i2` module implements A2I2 datasets."""
...
from one.data import (
    ClassLabels, ClassLabels_, DataModule, Detection,
    Detections, Image, ImageDetectionDataset, ImageEnhancementDataset,
)
...
@coreml.DATASET.register(name="a2i2-haze")
...
@coreml.DATASET.register(name="a2i2-haze-det")
...
@coreml.DATAMODULE.register(name="a2i2-haze")
...
@coreml.DATAMODULE.register(name="a2i2-haze-det")
...
def test_a2i2_haze():
    cfg = {
        "name": "a2i2haze",
            # Dataset's name.
        "root": foundation.DATA_DIR / "a2i2" / "haze",
