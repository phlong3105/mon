...
@DATASETS.register(name="coco17-detection")
...
@DATAMODULES.register(name="coco17-detection")
...
def parse_args():
    ...
    parser.add_argument("--task", type=str , default="test-coco17-detection", help="The task to run")
...
if __name__ == "__main__":
    args = parse_args()
    if args.task == "test-coco17-detection":
