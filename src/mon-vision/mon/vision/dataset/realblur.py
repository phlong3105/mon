...
@DATASETS.register(name="realblur-j")
...
@DATASETS.register(name="realblur-r")
...
@DATAMODULES.register(name="realblur-j")
...
@DATAMODULES.register(name="realblur-r")
...
def parse_args():
    ...
    parser.add_argument("--task", type=str , default="test-realblur-j", help="The task to run")
...
if __name__ == "__main__":
    args = parse_args()
    if args.task == "test-realblur-j":
        test_realblurj()
    elif args.task == "test-realblur-r":
        test_realblurr()
