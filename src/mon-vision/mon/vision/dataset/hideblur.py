...
@DATASETS.register(name="hide-blur")
...
@DATAMODULES.register(name="hide-blur")
...
def parse_args():
    ...
    parser.add_argument("--task", type=str , default="test-hide-blur", help="The task to run")
