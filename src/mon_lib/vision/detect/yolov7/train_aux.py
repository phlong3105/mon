...
def train(hyp, opt, device, tb_writer=None):
    ...
    save_dir, epochs, batch_size, total_batch_size, weights, rank = \
        core.Path(opt.save_dir), opt.epochs, opt.batch_size, opt.total_batch_size, opt.weights, opt.global_rank
...
if __name__ == '__main__':
    ...
    if opt.resume and not wandb_run:  # resume an interrupted run
        ...
        opt.save_dir = increment_path(core.Path(opt.project) / opt.name, exist_ok=opt.exist_ok | opt.evolve)  # increment run
