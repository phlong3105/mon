...
class TrainOptions:
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--content_share',     action='store_true',        help='set content encoder shared')
        self.parser.add_argument('--dataset',           type=str, default='pair',   help='path for saving result images and models')
        ...
        self.parser.add_argument('--attri_share',     action='store_true',           help='set attribute encoder shared')
...
class TestOptions:
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--gpu',             type=int, default=0, help='gpu')
        self.parser.add_argument('--content_share',   action='store_true', help='set content encoder shared')
        self.parser.add_argument('--dataset',         type=str, default='pair', help='dataset type')
        self.parser.add_argument('--vgg',             type=float, default=0, help='use perceptrual loss')
        self.parser.add_argument('--vgg_choose',      type=str, default='relu5_1', help='choose layer for vgg')
        self.parser.add_argument('--vgg_mean',        action='store_true', help='substract mean in vgg loss')
        self.parser.add_argument('--no_vgg_instance', action='store_true', help='vgg instance normalization')
