...
def div_data(img_path):
    ...
    try:
        ...
        pass
    for data_ in input_val:
        shutil.copy(data_, img_path + "/Inputs_jpg_val/")
        shutil.copy(data_.replace("Inputs_jpg", "Experts_C"), img_path + "/Experts_C_val/")
    for data_ in input_train:
        shutil.copy(data_, img_path + "/Inputs_jpg_train/")
        shutil.copy(data_.replace("Inputs_jpg", "Experts_C"), img_path + "/Experts_C_train/")
    return
