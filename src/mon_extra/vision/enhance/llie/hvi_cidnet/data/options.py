...
def option():
    ...
    parser.add_argument("--crop_size",   type=int,   default=256,  help="image crop size (patch size)")
    parser.add_argument("--epochs",      type=int,   default=1000, help="number of epochs to train for end")
    ...
    parser.add_argument("--data_train_lol_v2_real"     , type=str, default="./datasets/LOLv2/Real_captured/Train")
    parser.add_argument("--data_train_lol_v2_synthetic", type=str, default="./datasets/LOLv2/Synthetic/Train")
    ...
    parser.add_argument("--data_val_lol_v2_real"     , type=str, default="./datasets/LOLv2/Real_captured/Test/Low")
    parser.add_argument("--data_val_lol_v2_synthetic", type=str, default="./datasets/LOLv2/Synthetic/Test/Low")
    ...
    parser.add_argument("--data_valgt_lol_v2_real"     , type=str, default="./datasets/LOLv2/Real_captured/Test/Normal/")
    parser.add_argument("--data_valgt_lol_v2_synthetic", type=str, default="./datasets/LOLv2/Synthetic/Test/Normal/")
    ...
    parser.add_argument("--lol_v2_real",      type=bool, default=False)
    parser.add_argument("--lol_v2_synthetic", type=bool, default=False)
