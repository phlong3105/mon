...
parser.add_argument("--de_type",        type=list,  default=["denoise_15", "denoise_25", "denoise_50", "derain", "dehaze"], help="which type of degradations is training and testing for.")
