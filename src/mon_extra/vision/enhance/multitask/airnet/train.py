...
if __name__ == "__main__":
    ...
    for epoch in range(opt.epochs):
        ...
        if epoch < opt.epochs_encoder:
            print("Epoch (%d)  Loss: contrast_loss:%0.4f\n" % (epoch, contrast_loss.item(),), "\r", end='')
        else:
            print("Epoch (%d)  Loss: l1_loss:%0.4f contrast_loss:%0.4f\n" % (epoch, l1_loss.item(), contrast_loss.item(),), "\r", end="")
