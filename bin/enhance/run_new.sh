...
for d in "${datasets[@]}"; do
  # De-Raining
  if [ "$d" == "gt-rain" ]; then
    input_dirs+=("${data_dir}/${task}/${run}/${d}/rain")
    target_dirs+=("${data_dir}/${task}/${run}/${d}/clear")
  fi
  if [ "$d" == "rain100h" ]; then
    input_dirs+=("${data_dir}/${task}/${run}/${d}/rain")
    target_dirs+=("${data_dir}/${task}/${run}/${d}/clear")
  ...
  # LES
  if [ "$d" == "jin2022" ]; then
    input_dirs+=("${data_dir}/${task}/train/${d}/light-effects")
    target_dirs+=("")
  fi
  if [ "$d" == "ledlight" ]; then
    input_dirs+=("${data_dir}/${task}/test/${d}/light-effects")
    target_dirs+=("${data_dir}/${task}/test/${d}/clear")
  fi

  # LLIE
  if [ "$d" == "darkcityscapes" ]; then
    input_dirs+=("${data_dir}/${task}/test/${d}/low")
    target_dirs+=("${data_dir}/${task}/test/${d}/high")
  fi
  if [ "$d" == "darkface" ]; then
    input_dirs+=("${data_dir}/${task}/test/${d}/low")
    target_dirs+=("")
  ...
  if [ "$d" == "fivek-c" ]; then
    input_dirs+=("${data_dir}/${task}/train/${d}/low")
    target_dirs+=("${data_dir}/${task}/train/${d}/high")
  fi
  if [ "$d" == "fivek-e" ]; then
    input_dirs+=("${data_dir}/${task}/train/${d}/low")
    target_dirs+=("${data_dir}/${task}/train/${d}/high")
  ...
  if [ "$d" == "lol-v1" ]; then
    input_dirs+=("${data_dir}/${task}/${run}/${d}/low")
    target_dirs+=("${data_dir}/${task}/${run}/${d}/high")
  fi
  ...
  if [ "$d" == "sice" ]; then
    if [ "$run" == "train" ]; then
      input_dirs+=("${data_dir}/${task}/train/sice-part1/low")
      target_dirs+=("${data_dir}/${task}/train/sice-part1/high")
    else
      input_dirs+=("${data_dir}/${task}/train/sice-part2/low")
      target_dirs+=("${data_dir}/${task}/train/sice-part2/high")
    fi
  fi
  if [ "$d" == "sice-grad" ]; then
    input_dirs+=("${data_dir}/${task}/train/${d}/low")
