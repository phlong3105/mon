...
@click.option("--output-dir", default=mon.DATA_DIR/"vipriors/delftbikes/train/labels-yolo", type=click.Path(exists=False), help="Output directory.")
            ...
            with open(output_file, "w") as out:
                for ind, i in enumerate(data["parts"], 0):
                    ...
                    if label["object_state"] != "absent":
                        ...
                        loc                = label["relative_bounding_box"]
                        xmin               = loc["left"]
                        ymin               = loc["top"]
                        width              = loc["width"]
                        height             = loc["height"]
                        ...
                        # out.write(f"{part_name} {xmin} {ymin} {xmax} {ymax} {object_state} {object_state_class}\n")
                        out.write(f"{ind} {cx} {cy} {width} {height} {trust} {object_state_class} \n")
