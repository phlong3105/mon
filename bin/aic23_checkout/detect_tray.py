...
@click.command()
@click.option("--source",      default=mon.DATA_DIR/"aic23-checkout/testA/background/", type=click.Path(exists=True), help="Video filepath or directory.")
@click.option("--destination", default=mon.DATA_DIR/"aic23-checkout/testA/tray/", type=click.Path(exists=False), help="Output video filepath or directory.")
