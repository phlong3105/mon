...
@click.command()
@click.option("--image-dir",      default=mon.DATA_DIR/"aic23-autocheckout/testA/testA_4/images/", type=click.Path(exists=True), help="Image directory.")
@click.option("--label-dir",      default=mon.DATA_DIR/"aic23-autocheckout/testA/testA_4/person/labels/", type=click.Path(exists=True), help="Segmentation label directory.")
