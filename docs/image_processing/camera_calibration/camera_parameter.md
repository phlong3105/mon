...
system to the camera coordinate system is known as the camera extrinsic matrix.
...
entering and leaving the camera center has the same angle with the x and y-axis, 
