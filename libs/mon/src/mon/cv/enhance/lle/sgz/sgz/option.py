...
parser.add_argument("--output-dir",       type=str,   default="predict/vision/enhance/lle/sgz")
parser.add_argument("--weights",          type=str,   default="vision/enhance/lle/sgz/sgz-lol.pt")
...
parser.add_argument("--checkpoints-dir",  type=str,   default="train/vision/enhance/lle/sgz")
