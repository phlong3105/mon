...
@MODELS.register(variant="sam_b", name="sam")
class SAM_B(SAM):
...
@MODELS.register(variant="sam_l", name="sam")
class SAM_L(SAM):
...
@MODELS.register(variant="sam2_t", name="sam2")
class SAM2_T(SAM):
...
@MODELS.register(variant="sam2_s", name="sam2")
class SAM2_S(SAM):
...
@MODELS.register(variant="sam2_b", name="sam2")
class SAM2_B(SAM):
...
@MODELS.register(variant="sam2_l", name="sam2")
class SAM2_L(SAM):
