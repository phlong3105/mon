...
class DISTS(torch.nn.Module):
    ...
    def __init__(self, load_weights=True):
        ...
        if load_weights:
            weights = torch.load(os.path.join("/data/wengjian/low-light-enhancement/pami/loss/DISTS_pytorch", 'weights.pt'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ref', type=str, default='/data/wengjian/low-light-enhancement/pami/loss/DISTS_pytorch/images/r0.png')
    parser.add_argument('--dist', type=str, default='/data/wengjian/low-light-enhancement/pami/loss/DISTS_pytorch/images/r1.png')
