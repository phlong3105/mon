...
This module provides color-related operations for computer vision tasks.
"""
...
def rgb_to_hsv(rgb: Tensor) -> Tensor:
    ...
    Returns:
        Tensor: The corresponding HSV image tensor of shape (B, 3, H, W) and
...
def hsv_to_rgb(hsv: Tensor) -> Tensor:
    ...
    Args:
        hsv (Tensor): An HSV image tensor of shape (B, 3, H, W) and values
            ranging from 0.0 to 1.0.

    Returns:
        Tensor: The corresponding RGB image tensor of shape (B, 3, H, W) and
            values ranging from 0.0 to 1.0.
    """
...
def color_transfer(source: ndarray, target: ndarray) -> ndarray:
    ...
    Args:
        source (ndarray): An RGB source image array of shape (H, W, C) and
            values ranging from 0 to 255.
        target (ndarray): An RGB target image array of shape (H, W, C) and
            values ranging from 0 to 255.

    Returns:
        ndarray: The color transferred image array of shape (H, W, C) and values
