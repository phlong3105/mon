...
This module provides various common loss functions that can be used for
training models.
"""
...
class CosineSimilarityLoss(Loss):
    ...
    def __init__(self, dim: int = 1, eps: float = 1e-6, reduction: str = "mean"):
        ...
        Args:
            dim (int, optional): Dimension along which to compute the cosine
                similarity. Defaults to 1.
            eps (float, optional): Small constant for numerical stability.
                Defaults to 1e-6.
            reduction (str, optional): Reduction method to apply to the loss.
                One of: ["mean", "sum", "none"]. Defaults to "mean".
