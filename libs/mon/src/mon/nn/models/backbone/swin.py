...
class Swin_T_Weights(WeightsEnum):
    ...
    IMAGENET1K_V1 = Weights(
        path=ZOO_ROOT / "nn/backbone/swin/swin_t/imagenet1k_v1/swin_t_imagenet1k_v1.pth",
...
class Swin_S_Weights(WeightsEnum):
    ...
    IMAGENET1K_V1 = Weights(
        path=ZOO_ROOT / "nn/backbone/swin/swin_s/imagenet1k_v1/swin_s_imagenet1k_v1.pth",
...
class Swin_B_Weights(WeightsEnum):
    ...
    IMAGENET1K_V1 = Weights(
        path=ZOO_ROOT / "nn/backbone/swin/swin_b/imagenet1k_v1/swin_b_imagenet1k_v1.pth",
...
class Swin_V2_T_Weights(WeightsEnum):
    ...
    IMAGENET1K_V1 = Weights(
        path=ZOO_ROOT / "nn/backbone/swin/swin_v2_t/imagenet1k_v1/swin_v2_t_imagenet1k_v1.pth",
...
class Swin_V2_S_Weights(WeightsEnum):
    ...
    IMAGENET1K_V1 = Weights(
        path=ZOO_ROOT / "nn/backbone/swin/swin_v2_s/imagenet1k_v1/swin_v2_s_imagenet1k_v1.pth",
...
class Swin_V2_B_Weights(WeightsEnum):
    ...
    IMAGENET1K_V1 = Weights(
        path=ZOO_ROOT / "nn/backbone/swin/swin_v2_b/imagenet1k_v1/swin_v2_b_imagenet1k_v1.pth",
