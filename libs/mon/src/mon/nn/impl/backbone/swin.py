...
class SwinBackBone(nn.Module):
    ...
    def __init__(
        ...
        *args, **kwargs
        ...
        Args:
            variant: Variant of Swin Transformer to use.
...
def swin_t(weights: WeightsEnum | str = Swin_T_Weights.DEFAULT, out_indices: list = None, **kwargs):
    return SwinBackBone(
        variant               = "swin_t",
        patch_size            = [4, 4],
        embed_dim             = 96,
...
def swin_s(weights: WeightsEnum | str = Swin_S_Weights.DEFAULT, out_indices: list = None, **kwargs):
    return SwinBackBone(
        variant               = "swin_s",
        patch_size            = [4, 4],
        embed_dim             = 96,
...
def swin_b(weights: WeightsEnum | str = Swin_B_Weights.DEFAULT, out_indices: list = None, **kwargs):
    return SwinBackBone(
        variant               = "swin_b",
        patch_size            = [4, 4],
        embed_dim             = 128,
...
def swin_v2_t(weights: WeightsEnum | str = Swin_V2_T_Weights.DEFAULT, out_indices: list = None, **kwargs):
    return SwinBackBone(
        variant               = "swin_v2_t",
        patch_size            = [4, 4],
        embed_dim             = 96,
...
def swin_v2_s(weights: WeightsEnum | str = Swin_V2_S_Weights.DEFAULT, out_indices: list = None, **kwargs):
    return SwinBackBone(
        variant               = "swin_v2_s",
        patch_size            = [4, 4],
        embed_dim             = 96,
...
def swin_v2_b(weights: WeightsEnum | str = Swin_V2_B_Weights.DEFAULT, out_indices: list = None, **kwargs):
    return SwinBackBone(
        variant               = "swin_v2_b",
        patch_size            = [4, 4],
        embed_dim             = 128,
