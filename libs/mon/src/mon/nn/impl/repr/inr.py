...
class FFN(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            B (float): Fourier feature mapping scale factor. Defaults to 20.0.
...
class Siren(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            hidden_layers (int): Number of hidden layers.
            w0 (float): Frequency scaling factor for the first layer.
                Defaults to 30.0.
            w (float): Frequency scaling factor for the hidden layers.
                Defaults to 30.0.
        """
        super().__init__()
...
def create_coords(size: int_2_t, device: torch.device) -> Tensor:
    ...
    Args:
        size (int | tuple[int, int]): Size of the grid.
