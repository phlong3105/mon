...
class SCI_Weights(WeightsEnum):
    ...
    EASY = Weights(
        path=K.ZOO_ROOT / "enhance/llie/sci/sci/pretrained/sci_easy.pt",
        url=None,
        num_classes=None,
        transforms=None,
        meta={},
    ...
    MEDIUM = Weights(
        path=K.ZOO_ROOT / "enhance/llie/sci/sci/pretrained/sci_medium.pt",
        url=None,
        num_classes=None,
        transforms=None,
        meta={},
    ...
    DIFFICULT = Weights(
        path=K.ZOO_ROOT / "enhance/llie/sci/sci/pretrained/sci_difficult.pt",
        url=None,
        num_classes=None,
        transforms=None,
        meta={},
...
class SCI_PP_Weights(WeightsEnum):
    ...
    DEFAULT = Weights(
        path=K.ZOO_ROOT / "enhance/llie/sci/sci++/pretrained/sci++_1_3500.pt",
        url=None,
        num_classes=None,
        transforms=None,
        meta={},
