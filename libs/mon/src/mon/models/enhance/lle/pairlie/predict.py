...
This module provides prediction runner classes for PairLIE models.
"""
...
@PREDICTORS.register(name="pairlie")
class PairLIE_Predictor(Predictor):
    """Predictor for PairLIE models."""
