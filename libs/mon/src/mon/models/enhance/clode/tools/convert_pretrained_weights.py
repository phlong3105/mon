...
file = Path("/Volumes/ssd_01/10_workspace/11_code/mon/zoo/enhance/clode/clode/universal/clode_universal.pt")
new_file = file.parent / file.stem + "_new.pt"

state_dict = torch.load(str(file), map_location="cpu")
...
torch.save(state_dict, str(new_file))
