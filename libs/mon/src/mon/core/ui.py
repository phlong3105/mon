...
This module provides terminal and GUI components.
"""
...
from mon.core.data.device import query_ram_usages, query_vram_usage
...
class MemoryUsageColumn(ProgressColumn):
    ...
    def __init__(
        ...
        Args:
            devices (int | list[int], optional): List of GPU device indices to
                query. Defaults to 0.
