...
class RandomPerspective:
    ...
    def box_candidates(self, box1, box2, wh_thr=2, ar_thr=100, area_thr=0.1, eps=1e-16):  # bbox1(4,n), bbox2(4,n)
        # Compute bbox candidates: bbox1 before augment, bbox2 after augment, wh_thr (pixels), aspect_ratio_thr, area_ratio
