...
def bbox_ioa(box1, box2, eps=1e-7):
    """Returns the intersection over bbox2 area given bbox1, bbox2. Boxes are x1y1x2y2
    bbox1:       np.array of shape(nx4)
    bbox2:       np.array of shape(mx4)
...
def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, eps=1e-7):
    # Returns Intersection over Union (IoU) of bbox1(1,4) to bbox2(n,4)
    ...
    if CIoU or DIoU or GIoU:
        cw = b1_x2.maximum(b2_x2) - b1_x1.minimum(b2_x1)  # convex (smallest enclosing bbox) width
