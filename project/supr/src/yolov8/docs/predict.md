...
```python
boxes.xyxy  # bbox with xyxy format, (N, 4)
boxes.xywh  # bbox with xywh format, (N, 4)
boxes.xyxyn  # bbox with xyxy format but normalized, (N, 4)
boxes.xywhn  # bbox with xywh format but normalized, (N, 4)
