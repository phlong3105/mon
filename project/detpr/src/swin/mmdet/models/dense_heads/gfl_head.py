...
class Integral(nn.Module):
    ...
    def forward(self, x):
        ...
        Returns:
            x (Tensor): Integral result of bbox locations, i.e., distance
                offsets from the bbox center in four directions, shape (N, 4).
        """
...
class GFLHead(AnchorHead):
    ...
    2) flexible General distribution for bounding bbox locations,
