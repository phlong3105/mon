...
class YOLOV3Head(BaseDenseHead, BBoxTestMixin):
    ...
    def get_bboxes(
        ...
        result_list = self._get_bboxes(
            pred_maps_list, scale_factors, cfg,
            rescale, with_nms
        )
        return result_list
    ...
    def _get_bboxes(
        ...
        device = pred_maps_list[0].devices
    ...
    def get_targets(
        self, anchor_list, responsible_flag_list, gt_bboxes_list,
        gt_labels_list
    ):
        ...
        results = multi_apply(
            self._get_targets_single, anchor_list,
    ...
    def _get_targets_single(
        self, anchors, responsible_flags, gt_bboxes,
        gt_labels
    ):
