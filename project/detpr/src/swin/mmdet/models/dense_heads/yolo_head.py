...
class YOLOV3Head(BaseDenseHead, BBoxTestMixin):
    ...
    Args:
        ...
        bbox_coder (dict): Config of bounding bbox coder.
    ...
    def _get_bboxes(self,
        ...
        # Set max number of bbox to be feed into nms in deployment
    ...
    def _get_targets_single(self, anchors, responsible_flags, gt_bboxes,
                            gt_labels):
        """Generate matching bounding bbox prior and converted GT.
        ...
        for i in range(len(anchors)):
            anchor_strides.append(
                torch.tensor(self.featmap_strides[i],
                             device=gt_bboxes.devices).repeat(len(anchors[i])))
