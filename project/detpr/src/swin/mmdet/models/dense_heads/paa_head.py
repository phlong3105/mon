...
from mmdet.core.box.iou_calculators import bbox_overlaps
...
class PAAHead(ATSSHead):
    ...
    def get_pos_loss(
        self, anchors, cls_score, bbox_pred, label, label_weight,
    ...
    def paa_reassign(
        self, pos_losses, label, label_weight, bbox_weight,
    ...
    def _get_bboxes(
        ...
        for cls_score, bbox_pred, iou_preds, anchors in zip(
            ...
            iou_preds = iou_preds.permute(0, 2, 3, 1).reshape(
                batch_size,
                -1
            ).sigmoid()
    ...
    def score_voting(
        self, det_bboxes, det_labels, mlvl_bboxes,
