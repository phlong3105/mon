...
class VFNetHead(ATSSHead, FCOSHead):
    ...
    def forward_single(self, x, scale, scale_refine, stride, reg_denom):
        ...
        Returns:
            tuple: iou-aware cls scores for each bbox, bbox predictions and
    ...
    def get_bboxes(self,
        ...
        Returns:
            list[tuple[Tensor, Tensor]]: Each item in result_list is 2-tuple.
                ...
                are bounding bbox positions (tl_x, tl_y, br_x, br_y) and the
        ...
        Returns:
            tuple(Tensor):
                det_bboxes (Tensor): BBox predictions in shape (n, 5), where
                    the first 4 columns are bounding bbox positions
                    (tl_x, tl_y, br_x, br_y) and the 5-th column is a score
                    between 0 and 1.
                det_labels (Tensor): A (n,) tensor where each item is the
                    predicted class label of the corresponding bbox.
        """
