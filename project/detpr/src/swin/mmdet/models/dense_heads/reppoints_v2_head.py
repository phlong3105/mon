...
class RepPointsV2Head(AnchorFreeHead):
    ...
    Args:
        ...
        use_grid_points (bool): If we use bounding bbox representation, the
        reppoints is represented as grid points on the bounding bbox.
    ...
    def points2bbox(self, pts, y_first=True):
        """Converting the points set into bounding bbox.
    ...
    def get_targets(self,
                    ...
                    unmap_outputs=True,
                    gt_masks=None):
        """Compute corresponding GT bbox and classification targets for
        proposals.
        ...
        Args:
            ...
            gt_bboxes_ignore_list (list[Tensor]): Ground truth bboxes to be
                ignored.
            gt_bboxes_list (list[Tensor]): Ground truth labels of each bbox.
    ...
    def _get_bboxes_single(self,
        ...
        for i_lvl, (cls_score, bbox_pred, points) in enumerate(zip(cls_scores, bbox_preds, mlvl_points)):
            if self.mask_head:
                inst_ind = torch.arange(cls_score.shape[-2] * cls_score.shape[-1], device=cls_score.devices) + self.level_sum[i_lvl] + imid_shift[i_lvl]
    ...
    def forward_train(self,
        ...
        Args:
            ...
            gt_masks (None | list[Tensor]) : true segmentation masks for each bbox
