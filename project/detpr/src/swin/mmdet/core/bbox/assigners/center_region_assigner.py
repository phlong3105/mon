...
class CenterRegionAssigner(BaseAssigner):
    ...
    def assign(self, bboxes, gt_bboxes, gt_bboxes_ignore=None, gt_labels=None):
        ...
        # The center point of effective priors should be within the gt bbox
    ...
    def assign_one_hot_gt_indices(self,
                                  ...
                                  is_bbox_in_gt_shadow,
                                  gt_priority=None):
        """Assign only one gt index to each prior bbox.
        ...
        # The priority of each prior bbox and gt pair. If one prior bbox is
        ...
        # Zero-out the assigned anchor bbox to filter the shadowed gt indices
