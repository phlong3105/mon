...
def coco_eval_with_return(
    ...
    for res_type in result_types:
        assert res_type in ['proposal', 'box', 'segm', 'keypoints']
    ...
    for res_type in result_types:
        ...
        iou_type = 'box' if res_type == 'proposal' else res_type
        ...
        cocoEval.accumulate()
        cocoEval.summarize()
        if res_type == 'segm' or res_type == 'box':
            metric_names = [
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        nargs='+',
        choices=['proposal', 'proposal_fast', 'box', 'segm', 'keypoints'],
        help='eval types'
    )
    parser.add_argument(
        '--iou-thr',
    ...
    parser.add_argument(
        ...
        help='override some settings in the used config, the key-value pair '
             ...
             'to '
             'be overwritten is a list, it should be like key="[a,b]" or '
             'key=a,b '
             'It also allows nested list/tuple values, e.g. key="[(a,b),(c,'
             'd)]" '
