...
def load_mosaic(self, index):
    ...
    # Augment
    # img4 = img4[s // 2: int(s * 1.5), s // 2:int(s * 1.5)]  # center crop (WARNING, requires bbox pruning)
...
def box_candidates(box1, box2, wh_thr=2, ar_thr=20, area_thr=0.2):  # bbox1(4,n), bbox2(4,n)
