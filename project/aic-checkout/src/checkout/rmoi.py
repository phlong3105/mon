...
import mon
from checkout import constant
from checkout.typing import Ints, PathsType, PathType, PointsType, UIDType
...
def assign_detections_to_rois(dets: list, rois: Sequence[ROI]):
	"""Assign :class:`Detection` objects to ROIs.

	Args:
		dets: A list detections.
		rois: A list of :class:`ROI` objects.
	"""
	for d in dets:
